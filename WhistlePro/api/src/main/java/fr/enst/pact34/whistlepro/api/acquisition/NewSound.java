...
public class NewSound implements NewSoundInterface {
	...
	boolean isRecording = false; //quand la personne appuie sur le bouton record, devient true, quand elle r�-appuie pour arr�ter le record, redevient false
			...
			try
		      {
		         ...
		         {
		            long NbFramesRestantes = wavFile.getFramesRemaining(); //cela d�pend de la taille du buffer
	...
	public void captureAndPlay()
	{
			...
			SourceDataLine sourceLine; //sert � capturer
			TargetDataLine targetLine; //sert � jouer (play)
